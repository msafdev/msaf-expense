...
export default function Login({
  ...
  async function signUp(
    ...
    if (error) {
      ...
      return { title: "Signed up successfully", content: user?.email || "" };
    }
  }

  return (
    <div className="flex w-full flex-1">
      <div className="flex flex-col items-center w-full grow justify-center pad-x">
        ...
        <p className="text-sm text-foreground/60">OR</p>
